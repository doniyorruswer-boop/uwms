              ...
              <AppLayout>
                <Suspense fallback={<PageLoadingFallback />}>
                  <Routes>
                    ...
                    <Route path="quotas" element={<ProtectedRoute allowedRoles={getRoles('quotas')}><DesktopOnlyGuard pageTitle="Kafedralar va Bo‘limlar Kvotasi"><QuotasPage /></DesktopOnlyGuard></ProtectedRoute>} />
