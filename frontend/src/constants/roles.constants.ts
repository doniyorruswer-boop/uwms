...
export const ROLE_CONFIG: Record<RoleType, RoleMeta> = {
  SUPER_ADMIN: {
    code: 'SUPER_ADMIN',
    label: 'Super Admin',
    description: 'Tizim to‘liq ma’muri va barcha platforma modullarini nazorat qiluvchi',
    color: 'red',
    allowedRoutes: [
      '/dashboard',
      '/inbox',
  ...
  ADMIN: {
    code: 'ADMIN',
    label: 'Universitet Administratori',
    description: 'Universitet ichki ma’muri: xodimlar, tashkiliy tuzilma, ashyolar va omborni boshqaruvchi',
    color: 'blue',
    allowedRoutes: [
      '/dashboard',
      '/inbox',
...
export const formatRoleName = (role?: string): string => {
  ...
  const customMap: Record<string, string> = {
    ...
    TEACHER: 'O‘qituvchi',
    SUPER_ADMIN: 'Bosh administrator (Super Admin)',
