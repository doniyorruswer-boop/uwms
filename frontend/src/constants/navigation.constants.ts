...
export const NAVIGATION_ITEMS: NavItem[] = [
  ...
  },
  {
    ...
    allowedRoles: ['SUPER_ADMIN', 'ADMIN', 'HEAD_WAREHOUSE'],
  },
  {
    key: 'movements',
    path: '/movements',
    ...
    allowedRoles: ['SUPER_ADMIN', 'ADMIN', 'HEAD_WAREHOUSE', 'AUDITOR'],
  },
  {
    key: 'requests',
    path: '/requests',
  ...
  },
  {
    ...
    allowedRoles: ['SUPER_ADMIN', 'ADMIN', 'CHIEF_ACCOUNTANT', 'VICE_RECTOR_FINANCE', 'AUDITOR'],
  },
  {
    ...
    allowedRoles: ['SUPER_ADMIN', 'ADMIN', 'CHIEF_ACCOUNTANT', 'VICE_RECTOR_FINANCE', 'RECTOR', 'HEAD_WAREHOUSE'],
  },
  {
    key: 'fundingReports',
    ...
    allowedRoles: ['SUPER_ADMIN', 'ADMIN', 'HEAD_WAREHOUSE', 'MOL', 'CHIEF_ACCOUNTANT', 'VICE_RECTOR_FINANCE', 'RECTOR'],
  },
  {
    key: 'audit',
    path: '/audit',
    ...
    allowedRoles: ['AUDITOR', 'SUPER_ADMIN', 'ADMIN', 'HEAD_WAREHOUSE', 'RECTOR', 'VICE_RECTOR_FINANCE'],
  },
  {
    key: 'auditCampaigns',
    ...
    allowedRoles: ['AUDITOR', 'SUPER_ADMIN', 'ADMIN', 'HEAD_WAREHOUSE', 'RECTOR', 'VICE_RECTOR_FINANCE', 'CHIEF_ACCOUNTANT'],
  },
  {
    key: 'organization',
    path: '/organization',
  ...
  },
  {
    ...
    allowedRoles: ['SUPER_ADMIN', 'ADMIN', 'HEAD_WAREHOUSE', 'CHIEF_ACCOUNTANT', 'AUDITOR'],
  },
  {
    key: 'users',
    path: '/users',
